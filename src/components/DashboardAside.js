    ...
    <aside className="aside">
        ...
        <div className="aside__container">
            <nav className="aside__nav">
                <NavLink activeClassName="globalcar-bg-button " to="/globalcar/dashboard">
                ...
                <NavLink activeClassName="globalcar-bg-button " to="/globalcar/products">
                    <button id="dashboard"  className="aside__button--nav" type="button">
                ...
                <NavLink activeClassName="globalcar-bg-button mt-2" to="/globalcar/clientes">
                    <button id="dashboard"  className="aside__button--nav" type="button">
                ...
                <NavLink activeClassName="globalcar-bg-button mt-2" to="/globalcar/informes">
                    <button id="dashboard"  className="aside__button--nav" type="button">
                        <svg class="aside__icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
